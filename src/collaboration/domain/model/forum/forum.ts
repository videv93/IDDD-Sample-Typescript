...
import { ForumModeratorChanged } from './forum-moderator-changed';
  ...
  */
  ...
  moderatePost(
    ...
    this.assertArgumentEquals(
      post.forumId,
      this.forumId,
      'Not a post of this forum.',
    );
    this.assertStateTrue(
      this.isModeratedBy(moderator),
      'Not the moderator of this forum',
    );
  ...
  startDiscussion(
    forrumIdentityService: ForumIdentityService,
    author: Author,
    subject: string,
  ) {
    return this.startDiscussionFor(
      forrumIdentityService,
      author,
      subject,
      null,
    );
  ...
  startDiscussionFor(
    ...
    let discussion: Discussion = new Discussion(
      this.tenant,
      this.forumId,
      forumIdentityService.nextDiscussionId(),
      author,
      subject,
      exclusiveOwner,
    );
